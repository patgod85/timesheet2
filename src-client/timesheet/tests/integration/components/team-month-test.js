...
test('it renders', function (assert) {
    ...
    this.set('eventTypes', []);
    this.render(hbs`{{team-month year=2016 team=team showButtons=false event_types=eventTypes showActions=true}}`);
    ...
    this.render(hbs`{{team-month year=2016 team=team showButtons=false event_types=eventTypes showActions=false}}`);
