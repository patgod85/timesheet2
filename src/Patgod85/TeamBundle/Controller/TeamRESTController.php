...
use Patgod85\TeamBundle\Form\TeamType;
...
class TeamRESTController extends VoryxController
{
    ...
    {
        $entity = new Team();
        $form = $this->createForm(new TeamType(), $entity, array("method" => $request->getMethod()));
    ...
    /**
     * Partial Update to a Team entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function patchAction(Request $request, Team $entity)
    {
