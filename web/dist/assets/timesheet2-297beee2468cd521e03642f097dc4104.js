...
define("timesheet2/templates/my", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "uxeSmzgo", "block": "{\"statements\":[[\"append\",[\"unknown\",[\"outlet\"]],false],[\"text\",\"\\n\\n\"],[\"open-element\",\"h1\",[]],[\"flush-element\"],[\"text\",\"My team\"],[\"close-element\"],[\"text\",\"\\n\\n\"],[\"append\",[\"helper\",[\"team-month\"],null,[[\"year\",\"month\",\"changeMonthAction\",\"team\",\"showActions\"],[[\"get\",[\"year\"]],[\"get\",[\"selectedMonth\"]],[\"helper\",[\"action\"],[[\"get\",[null]],\"changeMonth\"],null],[\"get\",[\"model\",\"team\"]],false]]],false],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "timesheet2/templates/my.hbs" } });
});
...
if (!runningTests) {
  require("timesheet2/app")["default"].create({"name":"timesheet2","version":"0.0.1+3ef9cb22"});
}
